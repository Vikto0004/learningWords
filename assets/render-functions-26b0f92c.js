const l=a=>{let t="";for(let s=0;s<a;s++)t+=`<div class="add-wrap-item">
      ...
      /><input
        ...
        aria-describedby="inputGroup-sizing-lg"
      />
    </div>`;return t},r=a=>a.map(({title:t,number:s,progress:i,time:e})=>` <div class="modal-content rounded-4 shadow">
    ...
    </div>`).join("");export{r as a,l as m};
//# sourceMappingURL=render-functions-26b0f92c.js.map
